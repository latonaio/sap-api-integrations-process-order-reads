...
import (
	...
	sap_api_input_reader "sap-api-integrations-process-order-reads/SAP_API_Input_Reader"
	"sap-api-integrations-process-order-reads/config"
...
func main() {
	...
	caller.AsyncGetProcessOrder(
		inputSDC.ProcessOrder.ManufacturingOrder,
		accepter,
	)
}
